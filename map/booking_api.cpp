...
string const kServerUrl = "http://textual.ru/";
                                   ...
                                   function<void(vector<Details> const & details, bool success)> const & fn)
{
  ...
  string url = MakeApiUrl(kServerUrl, "booking_stub.json", {{"after", dateBegin},
                                                            {"before", dateEnd},
