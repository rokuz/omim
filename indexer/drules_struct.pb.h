...
class ColorsElementProto : public ::google::protobuf::MessageLite {
 public:
  ...
  // repeated .ColorElementProto colors = 1;
  inline int colors_size() const;
  inline void clear_colors();
  static const int kColorsFieldNumber = 1;
  inline const ::ColorElementProto& colors(int index) const;
  inline ::ColorElementProto* mutable_colors(int index);
  inline ::ColorElementProto* add_colors();
 ...
 private:
  ...
  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::ColorElementProto > colors_;
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void  protobuf_AddDesc_drules_5fstruct_2eproto_impl();
  #else
  friend void  protobuf_AddDesc_drules_5fstruct_2eproto();
...
// repeated .ColorElementProto colors = 1;
inline int ColorsElementProto::colors_size() const {
  return colors_.size();
}
inline void ColorsElementProto::clear_colors() {
  colors_.Clear();
}
inline const ::ColorElementProto& ColorsElementProto::colors(int index) const {
  // @@protoc_insertion_point(field_get:ColorsElementProto.colors)
  return colors_.Get(index);
}
inline ::ColorElementProto* ColorsElementProto::mutable_colors(int index) {
  // @@protoc_insertion_point(field_mutable:ColorsElementProto.colors)
  return colors_.Mutable(index);
}
inline ::ColorElementProto* ColorsElementProto::add_colors() {
  // @@protoc_insertion_point(field_add:ColorsElementProto.colors)
  return colors_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::ColorElementProto >&
ColorsElementProto::colors() const {
  // @@protoc_insertion_point(field_list:ColorsElementProto.colors)
  return colors_;
}
inline ::google::protobuf::RepeatedPtrField< ::ColorElementProto >*
ColorsElementProto::mutable_colors() {
  // @@protoc_insertion_point(field_mutable_list:ColorsElementProto.colors)
  return &colors_;
}
